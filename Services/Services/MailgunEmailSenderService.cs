...
namespace Services.Services
{
    public class MailgunEmailSenderService : IEmailSenderService
    {
        ...
        public static Task SendEmailAsync(List<string> emails, string subject, string message, string filemane = null)
        {
            RestClient client = new RestClient
            {
                BaseUrl = new Uri("https://api.mailgun.net/v3"),
            ...
            if (filemane != null) request.AddFile("attachment", filemane);
            request.Method = Method.POST;
